    ...
    async start() {
        return await new Promise(((resolve) => {
            for(let video of this.videos) {
                ...
                let task = new DownloadQuery(video.webpage_url, video.headers, video.rheaders, video, this.environment, progressBar, Utils.getVideoInPlaylistMetadata(video.url, null, this.playlistMetadata));
